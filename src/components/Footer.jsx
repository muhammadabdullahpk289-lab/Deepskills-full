...
function Footer() {
      ...
      <div className="footer-container">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-logo">
            <span className="footer-logo-icon"><img src={logo} alt="" /></span>
          </div>

          <p>
            Empowering the next generation of digital
            professionals with industry-relevant skills
            and hands-on training. Join our community
  ...
  <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/>
        ...
        <div className="footer-column">
          ...
          <a href="#">Full Stack (Laravel)</a>
          <a href="#">Full Stack (MERN)</a>
          <a href="#">WordPress Mastery</a>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
        ...
        <div className="footer-location">
          ...
          <div className="map-box">
            ...
            <iframe
              ...
              src="https://www.google.com/maps?q=Gulberg%20III%20Lahore%20Pakistan&output=embed"
               loading="eager"
               fetchPriority="high"
            ></iframe>
      ...
      <div className="footer-bottom">
        ...
        <p>
          © 2026 DEEPSKILLS. All rights reserved.
        </p>

...
import "./ReactDownload.css";

export default function ReactDownload() {
  return (
    <div className="reactdownload-wrapper">

      <svg
        className="reactdownload-squares"
      ...
      <div className="reactdownload-content">

        <h2 className="reactdownload-heading">
          Download the Complete
          <br />
          <span className="reactdownload-highlight">
            Course Outline
          </span>
        </h2>

        <p className="reactdownload-subtext">
          Want a detailed weekly breakdown and project roadmap?
        </p>

        <button className="reactdownload-btn">
          DOWNLOAD COURSE PDF
        </button>
